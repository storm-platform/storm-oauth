...
#
# Access Control module for the Storm platform. is free software; you can redistribute it and/or modify it
# under the terms of the MIT License; see LICENSE file for more details.
#

"""Configuration file for the Access Control module for the Storm platform. documentation.
...
project = 'STORM_ACCESS'
copyright = '2021, INPE.'
author = 'Brazil Data Cube Team'
release = storm_access.__version__
...
html_title = 'STORM_ACCESS'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'storm-access',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#STORM_ACCESS_EXAMPLE_URL = os.getenv('STORM_ACCESS_EXAMPLE_URL', None)
#'''
